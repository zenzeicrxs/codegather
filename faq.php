  ...
  <body>
    ...
    <section class="container faq">
      <div class="col">
        ...
        <br>
        <p><strong>Q: Mengapa saya tidak bisa login ketika sudah input data pada form pendaftaran?</strong></p>
        <p>A: Silahkan cek pos-el aktivasi akun yang telah terkirim ke pos-el pribadi Anda, periksa juga pada folder Junk atau Spam Mail lalu aktifkan akun.</p>
        <br>
        <p><strong>Q: Saya kesulitan upload foto KTP ukuran 700×400 px, bagaimana cara ubahnya ya?</strong></p>
        <p>A: Anda bisa menggunakan Aplikasi “Fast Image Resizer” atau Image Resizer Online di Internet, untuk ubah ukuran piksel fotonya.</p>
        <br>
        <p><strong>Q: Saya tidak bisa registrasi karena nama saya telah terpakai</strong></p>
        <p>A: Bisa diubah sedikit namamu saat mendaftar di Sisdiklat, dengan menambahkan Karakter 1x spasi kosong atau tambahkan 1 titik dipaling belakang namamu.</p>
        <br>
        <p><strong>Q: Saya tidak bisa registrasi karena User ID telah terpakai</strong></p>
        <p>A: Silahkan buat dan gunakan nama User ID yang baru saat Registrasi ulang di Sisdiklat.</p>
        <br>
        <p><strong>Q: Saya tidak bisa registrasi karena E-Mail telah terpakai</strong></p>
        <p>A: Silahkan buat dan gunakan akun E-Mail yang baru saat Registrasi ulang.</p>
      </div>
    </section>
    <!-- FAQ end -->
