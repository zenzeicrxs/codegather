<?php
  ...
  $q = $koneksi->query("SELECT * FROM berita WHERE id = '$id'") ;
  $dt = $q->fetch_assoc()
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Start Isi Berita-->
    <section class="container isiberita">
        <center><img src="images/<?= $dt['gambar'] ?>" class="img-fluid " style="width : 800px;" alt="..."> <br><br><br></center>
        <h1> <?= $dt['judul'] ?></h1><br>
        <p>
            <?= $dt['isiberita'] ?>
        </p> <br><br><br>
