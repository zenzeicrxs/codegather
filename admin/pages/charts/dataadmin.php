  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="../../index.php" class="logo"><b>Admin</b>Code Gather</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i>Berkas Persyaratan</a></li>
                <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i>Jadwal Diklat</a></li>
                <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i>Pengumuman Diklat</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
...
<br><br><br>
<input type="text" id="myInput" onkeyup="cari()" placeholder="Search for names.." title="Type in a name" style="margin-left: 10%">
          <table id="dtBasicExample"border="1" cellpadding="8" class="table table-striped table-bordered table-sm table-hover" style="width:80%" align="center">
        <tr>
            <th>NO</th>
            <th>Username</th>
            <th>Nama</th>
