  ...
  <body class="skin-blue">
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i>Tambah Data</a></li>
                <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i>Data Admin</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header profile">

                                <div class="card" style="padding:0 15vw " >
                                    <div class="card-body">
                                        <h4 class="header-title">Profile</h4>
                                        <form method="post" action="#" novalidate="novalidate" enctype="multipart/form-data" class="form-horizontal" id="validationform" data-parsley-validate="">
                                          
                                        <input class="form-control" type="hidden" id="example-text-input">
                                          <div class="form-group">
                                              <center><img src="images/user.png" style="width: 170px; height: 240px"></center><br>
                                              <input class="form-control" type="file" id="example-text-input">
                                          </div>
                                          <div class="form-group">
                                              <label for="example-text-input" class="col-form-label rounded">Nama Lengkap</label>
                                              <input class="form-control" type="text" id="example-text-input" autocomplete="off">
                                          </div>
                                          <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input id="inputEmail" type="email" data-parsley-trigger="change" autocomplete="off" class="form-control">
                                  </div>
                                  <div class="form-group">
                                      <label class="col-form-label" for="username">Username</label>
                                      <input type="text" id="username" class="form-control" data-parsley-length="[5,25]" autocomplete="off">
                                  </div>
                                          <div class="form-group">
                                      <label for="inputPassword">Password</label>
                                      <input id="inputPassword" type="password" class="form-control" data-parsley-length="[8,20]" autocomplete="off">
                                  </div>
                                  <input class="form-control" type="hidden" id="example-text-input">
                                  <div class="form-group">
